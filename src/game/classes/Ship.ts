...
import FindCellModule from "../modules/FindCellModule.ts";
...
export default class Ship {
  ...
  public getNewColRowData(findCellPlacementModule: FindCellModule, event: MouseEvent | TouchEvent): ColRowData | null {
